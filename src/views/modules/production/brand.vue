  ...
  <div class="mod-config">
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          v-if="isAuth('production:brand:save')"
          type="primary"
          @click="addOrUpdateHandle()"
          >新增</el-button
        >
        <el-button
          v-if="isAuth('production:brand:delete')"
          type="danger"
          @click="deleteHandle()"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl("/production/brand/list"),
        method: "get",
    ...
    updateBrandStatus(data){
      ...
      //发送更新请求
      this.$http({
      url: this.$http.adornUrl('/production/brand/update'),
      method: 'post',
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornUrl("/production/brand/delete"),
          method: "post",
